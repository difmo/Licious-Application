                    ...
                    Container(
                      ...
                      child: DropdownButtonHideUnderline(
                        child: DropdownButton<String>(
                          ...
                          hint: Row(
                            children: [
                              Icon(Icons.language_outlined, color: Colors.grey.shade500, size: 22),
                              const SizedBox(width: 12),
                              Text('Country', style: TextStyle(color: Colors.grey.shade500, fontSize: 15)),
                            ],
                          ),
...
/// Shared 3-step checkout stepper widget.
/// [currentStep]: 0 = Delivery, 1 = Address, 2 = Payment
      ...
      children: [
        ...
        Text(
          ...
          style: TextStyle(
            ...
            color: (done || active) ? const Color(0xFF38B24D) : Colors.grey.shade400,
            letterSpacing: 0.5,
          ),
        ),
      ],

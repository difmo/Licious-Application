...
class _ReviewSection extends ConsumerWidget {
          ...
          children: [
            const Text('Customer Reviews',
                style: TextStyle(
                    ...
                    color: Color(0xFF1A1A1A))),
            TextButton.icon(
              onPressed: () => _showAddReviewDialog(context, ref, productId),
  ...
  void _showAddReviewDialog(BuildContext context, WidgetRef ref, String pId) {
            ...
            children: [
              ...
              ElevatedButton(
                onPressed: () async {
                  ...
                  final messenger = ScaffoldMessenger.of(context);
                  final navigator = Navigator.of(context);
                  final res = await service.postReview(
                    productId: pId,
                    rating: rating,
                    comment: commentController.text,
                  );
                  if (res['success'] == true) {
                    ref.invalidate(productReviewsProvider(pId));
                    navigator.pop();
                    ...
                    messenger.showSnackBar(SnackBar(
                      content: Text(res['message'] ?? 'Failed to post review'),
        ...
        children: [
          Row(
            children: [
              CircleAvatar(
                radius: 20,
                backgroundColor: const Color(0xFF68B92E).withValues(alpha: 0.1),
                child: Text(
